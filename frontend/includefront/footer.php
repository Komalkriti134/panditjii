							...
							<div class="post-item">
								...
								<ul class="lab-ul footer-location">
									...
									<li>
										...
										<div class="content-part">
											<p>25/2  Street Building <br>Hazaribagh City</p>
										</div>
									</li>
								</ul>
							</div>
								...
								<div class="lab-ul footer-post">
									<div class="media mb-3">
										<div class="fp-thumb mr-3">
											<img src="assets/images/products/product/01.jpg" alt="recent-post">
										</div>
										<div class="media-body">
											<a href="#">
												<h6 class="mt-0">Agarbatti</h6>
											</a>
									...
									<div class="media mb-3">
										<div class="fp-thumb mr-3">
											<img src="assets/images/products/product/02.jpg" alt="recent-post">
										</div>
										<div class="media-body">
											<a href="#">
												<h6 class="mt-0">coconut</h6>
											</a>
											<span class="price">$25.99</span>
										</div>
									</div>
			...
			<div class="footer-bottom">
				<div class="container">
					<div class="section-wrapper">
						<p class="text-center">&copy; 2020 <a href="index.php">Pandit jii</a>.All Rights Reserved By <a href="https://themeforest.net/user/labartisan" target="_blank">LabArtisan</a></p>
					</div>
				</div>
			</div>
		</footer>
...
<!-- Mirrored from labartisan.net/demo/PoultryFarm/poultry-farm/index-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Jul 2021 06:29:13 GMT -->
</html>